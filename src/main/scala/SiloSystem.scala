...
trait SiloSystem {
  ...
  def fromFun[U, T <: Traversable[U]](host: Host)(fun: NullarySpore[LocalSilo[U, T]])
      (implicit p: Pickler[NullarySpore[LocalSilo[U, T]]], p2: Pickler[InitSiloFun[U, T]]): Future[SiloRef[U, T]] =
